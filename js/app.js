    ...
    if (!theName) {
        theName = "";
        myElement.innerHTML = '<h1 class="birth">Happy Birthday Titaa</h1>';
    } else {
    ...
    function newMessage() {
        myElement.innerHTML = '<h2><span id="gauche" class="material-icons">favorite</span> I Love You <span id="droite" class="material-icons">favorite</span></h2>';
        fade_in_button();
    }
